...
Estructura de salida principal:
    ...
    result/classification/resnet50_miniimagenet/<DEVICE_TAG>/
...
def main() -> None:
    ...
    plot_train_val_loss(
        ...
        title="Train vs Val Loss (ResNet-50)",
    )
    plot_accuracy(
        history["val_acc"],
        run_dir / "val_accuracy.png",
        title="Validation Accuracy (ResNet-50)",
    )
    ...
    plot_confusion_matrix(
        ...
        title="Matriz de confusión (cuentas) — ResNet-50",
    )

    plot_confusion_matrix(
        cm_norm,
        run_dir / "confusion_matrix_normalized.png",
        title="Matriz de confusión (normalizada por fila) — ResNet-50",
    )
    ...
    plot_per_class_metrics(
        ...
        metric="f1",
        title="F1 por clase (test) — ResNet-50",
    )
